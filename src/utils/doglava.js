 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
          ...
          function o(t, e, n) {
            if (t) {
              ...
              if (
                ...
                return (this.timer = new B({ duration: t, context: this, complete: a })), void (this.active = !0);
              if ('string' == o && e) {
                switch (t) {
                  case 'hide':
                    f.call(this);
            ...
            y('wait', function (t) {
              (t = c(t, 0)),
                this.active
                  ...
                  : ((this.timer = new B({ duration: t, context: this, complete: a })), (this.active = !0));
            }),
            y('then', function (t) {
              return this.active
        ...
        U = f(function (e) {
          ...
          (e.init = function (t) {
            ...
            (e.play = function () {
              var t;
              this.active ||
                (this.start || (this.start = D()), (this.active = !0), (t = this), 1 === c.push(t) && M(n));
            }),
            (e.stop = function () {
              var e, n, r;
              this.active &&
      ...
      x.transform &&
        ...
        x.transform &&
          x.backface &&
          ((q.z = [I, 'translateZ']), (q.rotateZ = [T]), (q.scaleZ = [g]), (q.perspective = [m]));
      var $ = /ms/,
        Z = /s|\./;
      return (t.tram = e);
    })(window.jQuery);
  ...
  function (t, e, n) {
                    ...
                    ? (function (t) {
                        ...
                        if ((0, f.default)(d)) {
                          (0, v.default)(d, function (t, e) {
                            ...
                            if (
                              (z(p, u.mediaQueryKeys) || n.dispatch((0, g.mediaQueriesDefined)()),
                                            ...
                                            if (
                                              ((g[u] = (function () {
                                                ...
                                                return (
                                                  ...
                                                  null == t &&
                                                    ((t = o.length), o.push({ keyframe: n, actionItems: [] })),
    ...
    function gt(t) {
      ...
      r.dispatch(
        (0, g.instanceAdded)(
          (0, a.default)({ instanceId: _, elementId: b, origin: R, refType: S, skipMotion: w, skipToValue: n }, o)
        )
      ),
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
                  ...
                  Nt(t, _, o),
                    a(
                      ...
                      I >= 1
                        ...
                        : 'rgba('.concat(g, ',').concat(y, ',').concat(m, ',').concat(I, ')')
                    );
                  break;
                default:
                  var T = c.unit,
      ...
      (e.shouldNamespaceEventParameter = function (t, e) {
        var n = e.basedOn;
        return (
          (t === v.EventTypeConsts.SCROLLING_IN_VIEW && (n === v.EventBasedOn.ELEMENT || null == n)) ||
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== h.EventBasedOn.ELEMENT || w || w !== a.elementHovered) &&
                ((A = f ? 1 - A : A), e.dispatch((0, _.parameterChanged)(S, A))),
...
Webflow.require('ix2').init({
  events: {
    'e-26': {
      ...
      target: { id: '638a3aab24a8d555a51c0527', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '638a3aab24a8d555a51c0527', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
    ...
    'e-28': {
      ...
      target: {
        id: '638a3aab24a8d555a51c0527|9d12e45f-d467-499a-399e-2a1b18190d59',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: '',
                duration: 0,
                target: { id: '638a3aab24a8d555a51c0527|dac13d37-bb6f-9005-532a-7b0f835d0517' },
                value: 'block',
              },
            },
          ],
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: '',
                duration: 500,
                target: { id: '638a3aab24a8d555a51c0527|b2fcbeb0-b893-4614-e247-f7b650bc47c2' },
                value: 0,
                unit: '',
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.formmodal',
                  selectorGuids: ['ab4f2f1f-1d84-a949-aa22-7634a20971a2'],
                },
                value: 0,
                unit: '',
              },
